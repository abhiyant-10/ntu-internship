...
import 'oxygen_graph_model.dart';
export 'oxygen_graph_model.dart';

class OxygenGraphWidget extends StatefulWidget {
  const OxygenGraphWidget({Key? key}) : super(key: key);

  @override
  _OxygenGraphWidgetState createState() => _OxygenGraphWidgetState();
}

class _OxygenGraphWidgetState extends State<OxygenGraphWidget>
    with TickerProviderStateMixin {
  late OxygenGraphModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OxygenGraphModel());
