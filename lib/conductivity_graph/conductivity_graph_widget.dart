...
import 'conductivity_graph_model.dart';
export 'conductivity_graph_model.dart';

class ConductivityGraphWidget extends StatefulWidget {
  const ConductivityGraphWidget({Key? key}) : super(key: key);

  @override
  _ConductivityGraphWidgetState createState() =>
      _ConductivityGraphWidgetState();
}

class _ConductivityGraphWidgetState extends State<ConductivityGraphWidget>
    with TickerProviderStateMixin {
  late ConductivityGraphModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConductivityGraphModel());
