...
import 'temp_graph_model.dart';
export 'temp_graph_model.dart';

class TempGraphWidget extends StatefulWidget {
  const TempGraphWidget({Key? key}) : super(key: key);

  @override
  _TempGraphWidgetState createState() => _TempGraphWidgetState();
}

class _TempGraphWidgetState extends State<TempGraphWidget>
    with TickerProviderStateMixin {
  late TempGraphModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TempGraphModel());
