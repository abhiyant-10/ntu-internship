...
import 'turbidity_graph_model.dart';
export 'turbidity_graph_model.dart';

class TurbidityGraphWidget extends StatefulWidget {
  const TurbidityGraphWidget({Key? key}) : super(key: key);

  @override
  _TurbidityGraphWidgetState createState() => _TurbidityGraphWidgetState();
}

class _TurbidityGraphWidgetState extends State<TurbidityGraphWidget>
    with TickerProviderStateMixin {
  late TurbidityGraphModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TurbidityGraphModel());
